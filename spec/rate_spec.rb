...
describe "Magpie::Rate" do
  [
    ...
    {name: "only max rate", json: "{\"max\":\"1.0\"}", min_rate: 1.0, max_rate: 1.0, rate: 1.0, to_json: "{\"min\":1.0,\"max\":1.0}"},
    ...
    {name: "only max rate (float values)", json: "{\"max\":1.0}", min_rate: 1.0, max_rate: 1.0, rate: 1.0, to_json: "{\"min\":1.0,\"max\":1.0}"},
